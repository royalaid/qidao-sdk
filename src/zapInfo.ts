...
export const PERF_TOKEN_ZAP_META: {
  ...
  [ChainId.MAINNET]: {
    ...
    [ETH_CBETH_VAULT_ADDRESS]: generateThreeStepZapper({
      perfToken: '0x97451025De0beef64c1A454bcF995de6FB8e0f2A',
      mooAssetVaultAddress: ETH_CBETH_VAULT_ADDRESS,
      underlying: new Token(ChainId.MAINNET, ETH_CBETH_ADDRESS, 18, 'Coinbase Wrapped Staked ETH'),
      underlyingPriceSourceAddress: '0x5f4ec3df9cbd43714fe2740f5e3616155c5b8419',
      zapperAddress: MAINNET_ZAPPER,
    }),
    [ETH_STETH_VAULT_ADDRESS]: generateThreeStepZapper({
      perfToken: '0x9414e766E8B59473599b9968aAf52CDCd07f59a9',
      mooAssetVaultAddress: ETH_STETH_VAULT_ADDRESS,
      underlying: new Token(ChainId.MAINNET, ETH_STETH_ADDRESS, 18, 'Liquid staked Ether 2.0'),
      underlyingPriceSourceAddress: '0x5f4ec3df9cbd43714fe2740f5e3616155c5b8419',
      zapperAddress: MAINNET_ZAPPER,
    }),
  },
